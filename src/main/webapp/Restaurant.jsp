...
<title>YumRush - Food Delivery App</title>
...
<body>
	...
	<header class="navbar">
		<div class="nav-container">
			<div class="logo">
				...
				<a href="home"class="home"><span>YumRush</span></a>
			</div>
			<nav class="nav-links">
	...
	<section class="hero">
		<div class="hero-content">
			<h1>Crave It, Get It, Fast! 😋</h1>
			<p>Order now from top local restaurants and get your favorite meals delivered fast 🏡⏰</p>
